...
/**@brief C_i-ые для развертки ключа */
const static ByteArray round_keys_constants[32]  = {
        ByteArray(std::vector<uint64_t>{13293016880751485550ULL, 113861975594575709ULL}),
        ByteArray(std::vector<uint64_t>{12967148488334542812ULL, 210485528703356602ULL}),
        ByteArray(std::vector<uint64_t>{832841251242517938ULL, 252007670754863591ULL}),
        ByteArray(std::vector<uint64_t>{11901856523503783291ULL, 294235849618463927ULL}),
        ByteArray(std::vector<uint64_t>{2112657851883024149ULL, 396828243321994218ULL}),
        ByteArray(std::vector<uint64_t>{1648163170943453863ULL, 504014529760907789ULL}),
        ByteArray(std::vector<uint64_t>{12584530462283786441ULL, 534268464357307728ULL}),
        ByteArray(std::vector<uint64_t>{9896103716966521334ULL, 588469787963816877ULL}),
        ByteArray(std::vector<uint64_t>{3543292263616543640ULL, 702050245610888432ULL}),
        ByteArray(std::vector<uint64_t>{4225103498021887530ULL, 775007669925229847ULL}),
        ByteArray(std::vector<uint64_t>{9428529166315977796ULL, 816811261204730442ULL}),
        ByteArray(std::vector<uint64_t>{3205972037871703181ULL, 882705345503323930ULL}),
        ByteArray(std::vector<uint64_t>{10666686628788647651ULL, 985016221301555271ULL}),
        ByteArray(std::vector<uint64_t>{11495849601114641233ULL, 1068536928701852064ULL}),
        ByteArray(std::vector<uint64_t>{2878712900618793279ULL, 1099072312484040445ULL}),
        ByteArray(std::vector<uint64_t>{15108461910207279663ULL, 1176731767193810329ULL}),
        ByteArray(std::vector<uint64_t>{7626356013546475585ULL, 1279043819798270660ULL}),
        ByteArray(std::vector<uint64_t>{7086584265239967219ULL, 1350899808339524387ULL}),
        ByteArray(std::vector<uint64_t>{15718357353213892509ULL, 1381436214338739326ULL}),
        ByteArray(std::vector<uint64_t>{8396936749702938452ULL, 1459661869155395886ULL}),
        ByteArray(std::vector<uint64_t>{14771139444362829114ULL, 1573241029737156211ULL}),
        ByteArray(std::vector<uint64_t>{14371964584432760968ULL, 1633128559332157332ULL}),
        ByteArray(std::vector<uint64_t>{9153902455655586534ULL, 1674931248653713609ULL}),
        ByteArray(std::vector<uint64_t>{6411454513896156121ULL, 1764915626282896948ULL}),
        ByteArray(std::vector<uint64_t>{16177008499281906103ULL, 1867509179646601577ULL}),
        ByteArray(std::vector<uint64_t>{16937650285125725189ULL, 1915707766766928014ULL}),
        ByteArray(std::vector<uint64_t>{6013668199776702059ULL, 1945962740726409171ULL}),
        ByteArray(std::vector<uint64_t>{18289659708723766946ULL, 2047845470559097475ULL}),
        ByteArray(std::vector<uint64_t>{5020287587231171788ULL, 2161706131874674142ULL}),
        ByteArray(std::vector<uint64_t>{5631043535591285118ULL, 2197936809804569657ULL}),
        ByteArray(std::vector<uint64_t>{17752965631107072784ULL, 2239458067111820132ULL}),
        ByteArray(std::vector<uint64_t>{7033237363641329502ULL, 2353392060742068977ULL})
};

// коэффициенты подстановки нелинейного преобразования
// nonlinear_transform_permutation
constexpr uint8_t S[S_TABLE_SIZE] = {
...
constexpr uint8_t inverse_S[S_TABLE_SIZE] = {
...
const static std::vector<uint16_t> linear_transform_coefficients = {
